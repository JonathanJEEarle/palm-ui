  ...
  var widget = (0, import_react12.useMemo)(function() {
    var createWidget = connector(function(connectorState, isFirstRender) {
      ...
      if (shouldSetStateRef.current) {
        var instantSearchInstance = connectorState.instantSearchInstance, widgetParams = connectorState.widgetParams, renderState = _objectWithoutProperties3(connectorState, _excluded2);
  ...
  var _useState = (0, import_react12.useState)(function() {
    if (widget.getWidgetRenderState) {
      ...
      var _widget$getWidgetRend = widget.getWidgetRenderState({
        ...
        error: search.error
      }), widgetParams = _widget$getWidgetRend.widgetParams, renderState = _objectWithoutProperties3(_widget$getWidgetRend, _excluded22);
      return renderState;
    }
    return {};
...
function DynamicWidgets(_ref) {
  var children = _ref.children, _ref$fallbackComponen = _ref.fallbackComponent, Fallback = _ref$fallbackComponen === void 0 ? DefaultFallbackComponent : _ref$fallbackComponen, props = _objectWithoutProperties4(_ref, _excluded3);
...
function getLocalWidgetsSearchParameters(widgets, widgetSearchParametersOptions) {
  var initialSearchParameters = widgetSearchParametersOptions.initialSearchParameters, rest = _objectWithoutProperties5(widgetSearchParametersOptions, _excluded4);
...
function getLocalWidgetsRecommendParameters(widgets, widgetRecommendParametersOptions) {
  var initialRecommendParameters = widgetRecommendParametersOptions.initialRecommendParameters, rest = _objectWithoutProperties5(widgetRecommendParametersOptions, _excluded23);
  return widgets.reduce(function(state, widget) {
...
function Index(_ref) {
  var children = _ref.children, props = _objectWithoutProperties6(_ref, _excluded5);
...
function getIndexStateWithoutConfigure(uiState) {
  var configure = uiState.configure, trackedUiState = _objectWithoutProperties7(uiState, _excluded6);
...
function InstantSearch2(_ref) {
  var children = _ref.children, props = _objectWithoutProperties8(_ref, _excluded7);
...
function InstantSearchSSRProvider(_ref) {
  var children = _ref.children, props = _objectWithoutProperties9(_ref, _excluded8);
  ...
  return function(widgetParams) {
    ...
    function _prepareFacetValues(facetValues) {
      return facetValues.slice(0, getLimit()).map(function(_ref22) {
        var label = _ref22.name, value = _ref22.escapedValue, data = _ref22.data, path = _ref22.path, subValue = _objectWithoutProperties10(_ref22, _excluded9);
...
function getStateWithoutPage(state) {
  var _ref = state || {}, page = _ref.page, rest = _objectWithoutProperties11(_ref, _excluded10);
  return rest;
}
function normalizeState(state) {
  var _ref22 = state || {}, clickAnalytics = _ref22.clickAnalytics, userToken = _ref22.userToken, rest = _objectWithoutProperties11(_ref22, _excluded24);
  return rest;
}
      ...
      getWidgetRenderState: function getWidgetRenderState(renderOptions) {
        ...
        if (results) {
          ...
          items = transformItems(facetItems.slice(0, getLimit()).map(function(_ref3) {
            var label = _ref3.name, value = _ref3.escapedValue, path = _ref3.path, item = _objectWithoutProperties12(_ref3, _excluded11);
...
var connectRefinementList = function connectRefinementList2(renderFn) {
  ...
  return function(widgetParams) {
    ...
    var formatItems = function formatItems2(_ref22) {
      var label = _ref22.name, value = _ref22.escapedValue, item = _objectWithoutProperties13(_ref22, _excluded12);
          ...
          if (query === "" && lastItemsFromMainSearch) {
            ...
            helper.searchForFacetValues(
              ...
              var normalizedFacetValues = transformItems(facetValues.map(function(_ref3) {
                var escapedValue = _ref3.escapedValue, value = _ref3.value, item = _objectWithoutProperties13(_ref3, _excluded25);
                return _objectSpread35(_objectSpread35({}, item), {}, {
                  value: escapedValue,
                  label: value
                });
...
function createHighlightComponent(_ref3) {
  ...
  return function Highlight3(userProps) {
    var parts = userProps.parts, _userProps$highlighte = userProps.highlightedTagName, highlightedTagName = _userProps$highlighte === void 0 ? "mark" : _userProps$highlighte, _userProps$nonHighlig = userProps.nonHighlightedTagName, nonHighlightedTagName = _userProps$nonHighlig === void 0 ? "span" : _userProps$nonHighlig, _userProps$separator = userProps.separator, separator = _userProps$separator === void 0 ? ", " : _userProps$separator, className = userProps.className, _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, props = _objectWithoutProperties(userProps, _excluded13);
...
function createHitsComponent(_ref) {
  ...
  return function Hits2(userProps) {
    var _userProps$classNames = userProps.classNames, classNames = _userProps$classNames === void 0 ? {} : _userProps$classNames, hits = userProps.hits, ItemComponent = userProps.itemComponent, sendEvent = userProps.sendEvent, EmptyComponent = userProps.emptyComponent, props = _objectWithoutProperties(userProps, _excluded14);
