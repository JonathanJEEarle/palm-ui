...
import {
  ...
  upload_default,
  useStyleRegister
} from "./chunk-OJDTTYRH.js";
import "./chunk-NJEVQ5NB.js";
import {
  require_dayjs_min
} from "./chunk-STBQYCIG.js";
import "./chunk-3JLJNR3C.js";
import {
  _assertThisInitialized,
  _createClass
} from "./chunk-WJ6FAM7H.js";
...
import {
  ...
  z,
  zr
} from "./chunk-Q2PQKI2X.js";
import {
  require_shim
} from "./chunk-EGQMEMFF.js";
import "./chunk-46WT6YR3.js";
import "./chunk-X63IIKQK.js";
import {
  require_jsx_runtime
} from "./chunk-B6DMN2DV.js";
import {
...
import {
  ...
  init_es,
  init_public_api
} from "./chunk-KXXXNYQJ.js";
import {
  _objectWithoutProperties
} from "./chunk-XLPMAEEH.js";
import {
  require_classnames
} from "./chunk-XZR4BP44.js";
import {
  _unsupportedIterableToArray
} from "./chunk-URUCDYIM.js";
import "./chunk-HTHQKSPX.js";
import {
  __assign
} from "./chunk-BNHVFL47.js";
import "./chunk-6CJ73D4S.js";
import "./chunk-C5Z4WKZ2.js";
import {
  require_react_dom
} from "./chunk-45SLNY5P.js";
import {
  require_react
  ...
  "node_modules/mdast-util-to-hast/lib/one.js"(exports, module) {
    ...
    function one(h, node, parent) {
      ...
      if (own.call(h.handlers, type)) {
        ...
        fn2 = h.unknownHandler;
      }
      return (typeof fn2 === "function" ? fn2 : unknown)(h, node, parent);
    }
    function text(node) {
      var data = node.data || {};
...
var require_warning = __commonJS({
  "node_modules/rc-util/lib/warning.js"(exports) {
    ...
    var warned = {};
    var preWarningFns = [];
    var preMessage = exports.preMessage = function preMessage2(fn2) {
...
var require_path_to_regexp2 = __commonJS({
  "node_modules/@umijs/route-utils/es/path-to-regexp.js"(exports) {
    ...
    function tokensToRegexp(tokens, keys, options) {
      ...
      var _a = options.strict, strict = _a === void 0 ? false : _a, _b2 = options.start, start = _b2 === void 0 ? true : _b2, _c = options.end, end = _c === void 0 ? true : _c, _d = options.encode, encode = _d === void 0 ? function(x) {
        return x;
      } : _d;
...
var useForm = function(config) {
  ...
  var _b2 = (0, import_react6.useState)({}), initialValues = _b2[0], setInitialValues = _b2[1];
...
var useStepsForm = function(config) {
  var _a = config || {}, form = _a.form, defaultFormValues = _a.defaultFormValues, _b2 = _a.defaultCurrent, defaultCurrent = _b2 === void 0 ? 0 : _b2, submit = _a.submit, total = _a.total, _c = _a.isBackValidate, isBackValidate = _c === void 0 ? true : _c;
...
var t = (e2, o2) => Jt(e2, "name", { value: o2, configurable: true });
var Te = t(({ action: e2, resource: o2, onMutationSuccess: s, onMutationError: r, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: d, successNotification: u, errorNotification: y, meta: l, metaData: g, queryMeta: m, mutationMeta: f, liveMode: b, liveParams: p, mutationMode: T, dataProviderName: P, onLiveEvent: C, invalidates: v, undoableTimeout: h, queryOptions: S, createMutationOptions: B, updateMutationOptions: L, id: k, overtimeOptions: c, optimisticUpdateMap: D, disableServerSideValidation: I = false } = {}) => {
  var se2, ee;
  let { options: U } = se(), Z2 = (U == null ? void 0 : U.disableServerSideValidation) || I, x = H(), [_] = form_default.useForm(), Q = useForm({ form: _ }), { form: H2 } = Q, V = OR({ onMutationSuccess: s || void 0, onMutationError: async (M, oe, re2) => {
    if (Z2) {
      r == null || r(M, oe, re2);
      return;
    }
    let $ = [], de = H2.getFieldsValue();
    $ = Object.keys(ar(de)).map((xe) => ({ name: Yo(xe), errors: void 0 })), H2.setFields($);
    let Ne = M == null ? void 0 : M.errors;
    for (let xe in Ne) {
      let ye = Ne[xe], Qe = [];
      Array.isArray(ye) && (Qe = ye), typeof ye == "string" && (Qe = [ye]), typeof ye == "boolean" && ye && (Qe = ["Field is not valid."]), typeof ye == "object" && "key" in ye && (Qe = [x(ye.key, ye.message)]), $.push({ name: Yo(xe), errors: Qe });
    }
    H2.setFields([...$]), r == null || r(M, oe, re2);
  }, redirect: d, action: e2, resource: o2, successNotification: u, errorNotification: y, meta: F(l, g), metaData: F(l, g), queryMeta: m, mutationMeta: f, liveMode: b, liveParams: p, mutationMode: T, dataProviderName: P, onLiveEvent: C, invalidates: v, undoableTimeout: h, queryOptions: S, createMutationOptions: B, updateMutationOptions: L, id: k, overtimeOptions: c, optimisticUpdateMap: D, autoSave: n2 }), { formLoading: X, onFinish: F2, queryResult: w, id: O, onFinishAutoSave: z2 } = V, { warnWhenUnsavedChanges: Y, setWarnWhen: G } = dt(), A = a ?? Y;
  import_react74.default.useEffect(() => {
    H2.resetFields();
  }, [(se2 = w == null ? void 0 : w.data) == null ? void 0 : se2.data, O]);
  let K = t((M) => {
    i && M.key === "Enter" && H2.submit();
  }, "onKeyUp"), j = t((M, oe) => {
    if (M && A && G(true), n2 != null && n2.enabled) {
      G(false);
      let re2 = (n2 == null ? void 0 : n2.onFinish) ?? (($) => $);
      return z2(re2(oe)).catch(($) => $);
    }
    return M;
  }, "onValuesChange"), J2 = { disabled: X, onClick: () => {
    H2.submit();
  } };
  return { form: Q.form, formProps: { ...Q.formProps, onFinish: (M) => F2(M).catch((oe) => oe), onKeyUp: K, onValuesChange: j, initialValues: (ee = w == null ? void 0 : w.data) == null ? void 0 : ee.data }, saveButtonProps: J2, ...V, onFinish: async (M) => await F2(M ?? Q.form.getFieldsValue(true)) };
}, "useForm");
var et = t(({ modalProps: e2 = {} } = {}) => {
  let { show: o2, close: s, visible: r } = Gh({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (n2) => {
    var i;
    (i = e2.onCancel) == null || i.call(e2, n2), s();
  }, open: r, visible: r }, show: o2, close: s };
}, "useModal");
var tt2 = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: s = true, autoResetForm: r = true, autoSave: n2, invalidates: i, ...a }) => {
  var G, A;
  let [d, u] = import_react75.default.useState(false), y = Ce(), { resource: l, action: g, identifier: m } = z(a.resource), f = ae(), b = ge(), p = nt(), T = a.action ?? g ?? "", P = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : l && T && e2 ? `modal-${m}-${T}` : void 0, v = Te({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: h, formProps: S, id: B, setId: L, formLoading: k, onFinish: c, autoSaveProps: D } = v, I = H(), { warnWhen: U, setWarnWhen: Z2 } = dt(), { show: x, close: _, modalProps: Q } = et({ modalProps: { open: o2 } }), H2 = Q.open || false, V = { modalProps: Q, form: h, formLoading: k, formProps: S, formResult: void 0, formValues: h.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: c, close: _, open: Q.open || false, show: x, visible: H2 };
  import_react75.default.useEffect(() => {
    var K, j, J2, se2;
    if (d === false && C) {
      let ee = (j = (K = f == null ? void 0 : f.params) == null ? void 0 : K[C]) == null ? void 0 : j.open;
      if (typeof ee == "boolean" ? ee && x() : typeof ee == "string" && ee === "true" && x(), P) {
        let M = (se2 = (J2 = f == null ? void 0 : f.params) == null ? void 0 : J2[C]) == null ? void 0 : se2.id;
        M && (L == null || L(M));
      }
      u(true);
    }
  }, [C, f, P, L]), import_react75.default.useEffect(() => {
    var K;
    d === true && (H2 && C ? b({ query: { [C]: { ...(K = f == null ? void 0 : f.params) == null ? void 0 : K[C], open: true, ...P && B && { id: B } } }, options: { keepQuery: true }, type: "replace" }) : C && !H2 && b({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [B, H2, x, C, P]);
  let X = { disabled: k, loading: k, onClick: () => {
    h.submit();
  } }, F2 = (0, import_react75.useCallback)(() => {
    if (D.status === "success" && (n2 != null && n2.invalidateOnClose) && y({ id: B, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), U)
      if (window.confirm(I("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        Z2(false);
      else
        return;
    L == null || L(void 0), V.close();
  }, [U, D.status]), w = (0, import_react75.useCallback)((K) => {
    typeof K < "u" && (L == null || L(K)), (!(T === "edit" || T === "clone") || (typeof K < "u" || typeof B < "u")) && V.show();
  }, [B]), { visible: O, ...z2 } = Q, Y = { open: O, ...z2 };
  return { ...v, ...V, show: w, close: F2, open: H2, formProps: { ...S, ...v.formProps, onValuesChange: S == null ? void 0 : S.onValuesChange, onKeyUp: S == null ? void 0 : S.onKeyUp, onFinish: async (K) => {
    await c(K), s && _(), r && h.resetFields();
  } }, modalProps: { ...Y, width: "1000px", okButtonProps: X, title: I(`${m}.titles.${a.action}`, `${p(`${a.action} ${((G = l == null ? void 0 : l.meta) == null ? void 0 : G.label) ?? ((A = l == null ? void 0 : l.options) == null ? void 0 : A.label) ?? (l == null ? void 0 : l.label) ?? m}`, "singular")}`), okText: I("buttons.save", "Save"), cancelText: I("buttons.cancel", "Cancel"), onCancel: F2, forceRender: true }, formLoading: k };
}, "useModalForm");
var st = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: s = true, autoResetForm: r = true, autoSave: n2, invalidates: i, ...a }) => {
  let d = Ce(), [u, y] = import_react76.default.useState(false), { visible: l, show: g, close: m } = Gh({ defaultVisible: o2 }), { resource: f, action: b, identifier: p } = z(a.resource), T = ae(), P = ge(), C = a.action ?? b ?? "", v = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), h = typeof e2 == "object" && "key" in e2 ? e2.key : f && C && e2 ? `drawer-${(f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name)}-${C}` : void 0, S = Te({ meta: { ...h ? { [h]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: B, formProps: L, formLoading: k, id: c, setId: D, onFinish: I, autoSaveProps: U } = S;
  import_react76.default.useEffect(() => {
    var F2, w, O, z2;
    if (u === false && h) {
      let Y = (w = (F2 = T == null ? void 0 : T.params) == null ? void 0 : F2[h]) == null ? void 0 : w.open;
      if (typeof Y == "boolean" ? Y ? g() : m() : typeof Y == "string" && Y === "true" && g(), v) {
        let G = (z2 = (O = T == null ? void 0 : T.params) == null ? void 0 : O[h]) == null ? void 0 : z2.id;
        G && (D == null || D(G));
      }
      y(true);
    }
  }, [h, T, v, D, u]), import_react76.default.useEffect(() => {
    var F2;
    u === true && (l && h ? P({ query: { [h]: { ...(F2 = T == null ? void 0 : T.params) == null ? void 0 : F2[h], open: true, ...v && c && { id: c } } }, options: { keepQuery: true }, type: "replace" }) : h && !l && P({ query: { [h]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [c, l, g, m, h, v, u]);
  let Z2 = H(), { warnWhen: x, setWarnWhen: _ } = dt(), Q = { disabled: k, onClick: () => {
    B.submit();
  }, loading: k }, H2 = { recordItemId: c, onSuccess: () => {
    D == null || D(void 0), m();
  } }, V = (0, import_react76.useCallback)(() => {
    if (U.status === "success" && (n2 != null && n2.invalidateOnClose) && d({ id: c, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: p }), x)
      if (window.confirm(Z2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        _(false);
      else
        return;
    m(), D == null || D(void 0);
  }, [x]), X = (0, import_react76.useCallback)((F2) => {
    typeof F2 < "u" && (D == null || D(F2)), (!(C === "edit" || C === "clone") || (typeof F2 < "u" || typeof c < "u")) && g();
  }, [c]);
  return { ...S, show: X, close: V, formProps: { form: B, ...S.formProps, onValuesChange: L == null ? void 0 : L.onValuesChange, onKeyUp: L == null ? void 0 : L.onKeyUp, onFinish: async (F2) => {
    await I(F2), s && m(), r && B.resetFields();
  } }, drawerProps: { width: "500px", onClose: V, open: l, forceRender: true }, saveButtonProps: Q, deleteButtonProps: H2, formLoading: k };
}, "useDrawerForm");
var nt2 = t((e2 = {}) => {
  let o2 = Te({ ...e2 }), { form: s, formProps: r } = o2, n2 = useStepsForm({ isBackValidate: false, form: s, submit: (i) => {
    var a;
    (a = r == null ? void 0 : r.onFinish) == null || a.call(r, i);
  }, ...e2 });
  return { ...o2, ...n2, formLoading: o2.formLoading, formProps: { ...n2.formProps, ...o2.formProps, onValuesChange: r == null ? void 0 : r.onValuesChange, onKeyUp: r == null ? void 0 : r.onKeyUp }, saveButtonProps: { ...o2.saveButtonProps, onClick: () => n2.submit() } };
}, "useStepsForm");
var vr = t((e2, o2) => {
  let s = oa(e2, o2);
  if (s)
...
var Lr = t((e2, o2, s = "eq") => na(e2, o2, s), "getDefaultFilter");
var fo = t((e2) => {
  let o2 = [];
  if (Array.isArray(e2))
    e2.sort((s, r) => {
      var n2, i;
      return (((n2 = s.column) == null ? void 0 : n2.sorter).multiple ?? 0) < (((i = r.column) == null ? void 0 : i.sorter).multiple ?? 0) ? -1 : 0;
    }).map((s) => {
      if (s.field && s.order) {
        let r = Array.isArray(s.field) ? s.field.join(".") : `${s.field}`;
        o2.push({ field: `${s.columnKey ?? r}`, order: s.order.replace("end", "") });
      }
    });
  else if (e2.field && e2.order) {
    let s = Array.isArray(e2.field) ? e2.field.join(".") : `${e2.field}`;
    o2.push({ field: `${e2.columnKey ?? s}`, order: e2.order.replace("end", "") });
  }
  return o2;
}, "mapAntdSorterToCrudSorting");
var yo = t((e2, o2, s) => {
  let r = [], n2 = (s ?? []).reduce((i, a) => {
    let d = a.key || a.field;
    return { ...i, [d]: a };
  }, {});
  return Object.keys(e2).map((i) => {
    var u, y;
    let a = e2[i], d = ((u = o2.filter((l) => l.operator !== "or").find((l) => l.field === i)) == null ? void 0 : u.operator) || ((y = n2[i]) == null ? void 0 : y.operator);
    d !== "or" && d !== "and" && r.push({ field: i, operator: d ?? (Array.isArray(a) ? "in" : "eq"), value: a });
  }), r;
}, "mapAntdFilterToCrudFilter");
var he = t(({ to: e2, element: o2 }) => {
  let { Link: s } = re(), r = Z(), n2 = tt();
  return import_react78.default.createElement(r === "legacy" ? s : n2, { to: e2, replace: false, onClick: (a) => {
    a.preventDefault();
  } }, o2);
}, "PaginationLink");
var go = t(({ onSearch: e2, initialCurrent: o2, initialPageSize: s, hasPagination: r = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: d, permanentFilter: u, defaultSetFilterBehavior: y, filters: l, sorters: g, syncWithLocation: m, resource: f, successNotification: b, errorNotification: p, queryOptions: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: h, metaData: S, dataProviderName: B } = {}) => {
  let { tableQueryResult: L, current: k, setCurrent: c, pageSize: D, setPageSize: I, filters: U, setFilters: Z2, sorters: x, setSorters: _, sorter: Q, setSorter: H2, createLinkForSyncWithLocation: V, pageCount: X, overtime: F2 } = sb({ permanentSorter: a, permanentFilter: u, initialCurrent: o2, initialPageSize: s, pagination: n2, hasPagination: r, filters: l, sorters: g, initialSorter: i, initialFilter: d, syncWithLocation: m, resource: f, defaultSetFilterBehavior: y, successNotification: b, errorNotification: p, queryOptions: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: F(h, S), metaData: F(h, S), dataProviderName: B }), w = grid_default.useBreakpoint(), [O] = form_default.useForm(), z2 = useForm({ form: O }), Y = Vn(P), G = r === false ? "off" : "server", A = ((n2 == null ? void 0 : n2.mode) ?? G) !== "off", K = F(l == null ? void 0 : l.initial, d), { data: j, isFetched: J2, isLoading: se2 } = L, ee = t((re2, $, de) => {
    ...
    A && (c == null || c(re2.current || 1), I == null || I(re2.pageSize || 10));
  }, "onChange"), M = t(async (re2) => {
    if (e2) {
      let $ = await e2(re2);
      Z2($), A && (c == null || c(1));
    }
  }, "onFinish"), oe = t(() => A ? { itemRender: (re2, $, de) => {
    var Ne;
    let ue = V({ pagination: { pageSize: D, current: re2 }, sorters: x, filters: U });
    if ($ === "page")
      return (0, import_react77.createElement)(he, { to: ue, element: `${re2}` });
    if ($ === "next" || $ === "prev")
      return (0, import_react77.createElement)(he, { to: ue, element: de });
    if ($ === "jump-next" || $ === "jump-prev") {
      let xe = (Ne = de == null ? void 0 : de.props) == null ? void 0 : Ne.children;
      return (0, import_react77.createElement)(he, { to: ue, element: import_react77.Children.count(xe) > 1 ? (0, import_react77.createElement)(import_react77.Fragment, {}, xe) : xe });
    }
    return de;
  }, pageSize: D, current: k, simple: !w.sm, position: w.sm ? ["bottomRight"] : ["bottomCenter"], total: j == null ? void 0 : j.total } : false, "antdPagination");
  return { searchFormProps: { ...z2.formProps, onFinish: M }, tableProps: { dataSource: j == null ? void 0 : j.data, loading: Y === "auto" ? se2 : !J2, onChange: ee, pagination: oe(), scroll: { x: true } }, tableQueryResult: L, sorters: x, sorter: Q, filters: U, setSorters: _, setSorter: H2, setFilters: Z2, current: k, setCurrent: c, pageSize: D, setPageSize: I, pageCount: X, createLinkForSyncWithLocation: V, overtime: F2 };
}, "useTable");
var Mr = t(({ autoSubmitClose: e2 = true, ...o2 } = {}) => {
  let s = go({ ...o2, successNotification: void 0, errorNotification: void 0 }), r = Te({ ...o2, action: "edit", redirect: false }), { id: n2, setId: i, saveButtonProps: a } = r, d = { onClick: () => {
    i(void 0);
  } }, u = t((l) => ({ onClick: () => i(l) }), "editButtonProps"), y = t((l) => l === n2, "isEditing");
  return { ...s, ...r, formProps: { ...r.formProps, onFinish: async (l) => {
    let g = await r.onFinish(l);
    return e2 && i(void 0), g;
  } }, saveButtonProps: a, cancelButtonProps: d, editButtonProps: u, isEditing: y };
}, "useEditableTable");
var Jm = t((e2) => {
  let { queryResult: o2, defaultValueQueryResult: s, onSearch: r, options: n2 } = OC(e2);
  return { selectProps: { options: n2, onSearch: r, loading: s.isFetching, showSearch: true, filterOption: false }, queryResult: o2, defaultValueQueryResult: s };
}, "useSelect");
var pc = t(({ resource: e2, sort: o2, sorters: s, filters: r, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: f, metaData: b, dataProviderName: p }) => {
  let { queryResult: T, options: P } = OC({ resource: e2, sort: o2, sorters: s, filters: r, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: F(f, b), metaData: F(f, b), dataProviderName: p });
  return { checkboxGroupProps: { options: P, defaultValue: l }, queryResult: T };
}, "useCheckboxGroup");
var xc = t(({ resource: e2, sort: o2, sorters: s, filters: r, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: f, metaData: b, dataProviderName: p }) => {
  let { queryResult: T, options: P } = OC({ resource: e2, sort: o2, sorters: s, filters: r, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: d, pagination: u, liveMode: y, defaultValue: l, onLiveEvent: g, liveParams: m, meta: F(f, b), metaData: F(f, b), dataProviderName: p });
  return { radioGroupProps: { options: P, defaultValue: l }, queryResult: T };
}, "useRadioGroup");
var wc = t(({ resource: e2, resourceName: o2, mapData: s = t((l) => l, "mapData"), paparseOptions: r, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: d, dataProviderName: u, onProgress: y } = {}) => {
  let l = H(), { resource: g } = z(e2 ?? o2), { mutationResult: m, isLoading: f, handleChange: b } = Vh({ resource: (g == null ? void 0 : g.identifier) ?? (g == null ? void 0 : g.name), mapData: s, paparseOptions: r, batchSize: n2, meta: F(a, d), metaData: F(a, d), dataProviderName: u, onFinish: i, onProgress: y ?? (({ totalAmount: p, processedAmount: T }) => {
    if (p > 0 && T > 0) {
      let P = import_react79.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react79.default.createElement(progress_default, { type: "circle", percent: Math.floor(T / p * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react79.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, l("notifications.importProgress", { processed: T, total: p }, `Importing: ${T}/${p}`)));
      notification_default.open({ description: P, message: null, key: `${g}-import`, duration: 0 }), T >= p, T === p && setTimeout(() => {
        notification_default.destroy(`${g}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: b, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: f }, mutationResult: m, isLoading: f };
}, "useImport");
var Jr = t(({ resource: e2, initialCurrent: o2, initialPageSize: s, pagination: r, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: d, permanentFilter: u, defaultSetFilterBehavior: y, filters: l, sorters: g, onSearch: m, queryOptions: f, syncWithLocation: b, successNotification: p, errorNotification: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: h, metaData: S, dataProviderName: B } = {}) => {
  let { sorters: L, sorter: k, filters: c, current: D, pageSize: I, pageCount: U, setFilters: Z2, setCurrent: x, setPageSize: _, setSorter: Q, setSorters: H2, createLinkForSyncWithLocation: V, tableQueryResult: X, overtime: F2 } = sb({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: d, permanentFilter: u, filters: l, sorters: g, defaultSetFilterBehavior: y, initialCurrent: o2, initialPageSize: s, queryOptions: f, successNotification: p, errorNotification: T, liveMode: P, onLiveEvent: C, liveParams: v, meta: F(h, S), metaData: F(h, S), syncWithLocation: b, dataProviderName: B, pagination: r, hasPagination: n2 }), w = n2 === false ? "off" : "server", O = ((r == null ? void 0 : r.mode) ?? w) !== "off", z2 = grid_default.useBreakpoint(), Y = Vn(P), [G] = form_default.useForm(), { data: A, isFetched: K, isLoading: j } = X, J2 = t((M, oe) => {
    O && (x(M), _(oe || 10));
  }, "onChange"), se2 = t(async (M) => {
    if (m) {
      let oe = await m(M);
      return O && (x == null || x(1)), Z2(oe);
    }
  }, "onFinish"), ee = t(() => O ? { itemRender: (M, oe, re2) => {
    var de;
    let $ = V({ pagination: { pageSize: I, current: M }, sorters: L, filters: c });
    if (oe === "page")
      return (0, import_react80.createElement)(he, { to: $, element: `${M}` });
    if (oe === "next" || oe === "prev")
      return (0, import_react80.createElement)(he, { to: $, element: re2 });
    if (oe === "jump-next" || oe === "jump-prev") {
      let ue = (de = re2 == null ? void 0 : re2.props) == null ? void 0 : de.children;
      return (0, import_react80.createElement)(he, { to: $, element: import_react80.Children.count(ue) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, ue) : ue });
    }
    return re2;
  }, pageSize: I, current: D, simple: !z2.sm, total: A == null ? void 0 : A.total, onChange: J2 } : false, "antdPagination");
  return { searchFormProps: { form: G, onFinish: se2 }, listProps: { dataSource: A == null ? void 0 : A.data, loading: Y === "auto" ? j : !K, pagination: ee() }, queryResult: X, filters: c, setFilters: Z2, sorter: k, setSorter: Q, sorters: L, setSorters: H2, current: D, setCurrent: x, pageSize: I, setPageSize: _, pageCount: U, createLinkForSyncWithLocation: V, overtime: F2 };
}, "useSimpleList");
var Zc = t(() => {
  let [e2, o2] = (0, import_react81.useState)(false), s = (0, import_react81.useCallback)((r) => {
    rs(r.fileList).includes(true) ? o2(true) : o2(false);
  }, []);
  return (0, import_react81.useMemo)(() => ({ isLoading: e2, onChange: s }), [e2]);
}, "useFileUploadState");
var rs = t((e2) => e2.map((o2) => {
  switch (o2.status) {
    case "uploading":
      return true;
    default:
...
var xo = t(({ children: e2, initialSiderCollapsed: o2 }) => {
  let [s, r] = (0, import_react83.useState)(o2 ?? false), [n2, i] = (0, import_react83.useState)(false);
  return import_react83.default.createElement(Ie.Provider, { value: { siderCollapsed: s, mobileSiderOpen: n2, setSiderCollapsed: r, setMobileSiderOpen: i } }, e2);
}, "ThemedLayoutContextProvider");
var pf = t(() => {
  let { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: s, setSiderCollapsed: r } = (0, import_react82.useContext)(Ie);
  return { siderVisible: e2, setSiderVisible: s, drawerSiderVisible: o2, setDrawerSiderVisible: r };
}, "useSiderVisible");
var ct = t(() => {
  let { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: s, setSiderCollapsed: r } = (0, import_react84.useContext)(Ie);
  return { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: s, setSiderCollapsed: r };
}, "useThemedLayoutContext");
var ho = t(({ message: e2, cancelMutation: o2, undoableTimeout: s }) => import_react86.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react86.default.createElement(progress_default, { type: "circle", percent: (s ?? 0) * 20, format: (r) => r && r / 20, size: 50, strokeColor: "#1890ff", status: "normal" }), import_react86.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react86.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: o2, disabled: s === 0, icon: import_react86.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
var Bf = { open: ({ key: e2, message: o2, description: s, type: r, cancelMutation: n2, undoableTimeout: i }) => {
  r === "progress" ? notification_default.open({ key: e2, description: import_react85.default.createElement(ho, { notificationKey: e2, message: o2, cancelMutation: () => {
    n2 == null || n2(), notification_default.destroy(e2 ?? "");
  }, undoableTimeout: i }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : notification_default.open({ key: e2, description: o2, message: s ?? null, type: r });
}, close: (e2) => notification_default.destroy(e2) };
var Sf = t(() => {
  let { notification: e2 } = app_default.useApp(), o2 = "open" in e2 ? e2 : notification_default;
  return { open: ({ key: r, message: n2, description: i, type: a, cancelMutation: d, undoableTimeout: u }) => {
    a === "progress" ? o2.open({ key: r, description: import_react85.default.createElement(ho, { notificationKey: r, message: n2, cancelMutation: () => {
      d == null || d(), o2.destroy(r ?? "");
    }, undoableTimeout: u }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : o2.open({ key: r, description: n2, message: i ?? null, type: a });
  }, close: (r) => o2.destroy(r) };
}, "useNotificationProvider");
var ft = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Co = t(({ Title: e2, render: o2, meta: s }) => {
  let [r, n2] = (0, import_react88.useState)(false), [i, a] = (0, import_react88.useState)(false), d = Yr(), u = Z(), y = tt(), { warnWhen: l, setWarnWhen: g } = dt(), { Link: m } = re(), f = u === "legacy" ? m : y, b = Ys(), p = H(), { menuItems: T, selectedKey: P, defaultOpenKeys: C } = hu({ meta: s }), v = grid_default.useBreakpoint(), { hasDashboard: h } = se(), S = J(), { mutate: B } = mr({ v3LegacyAuthProviderCompatible: !!(S != null && S.isLegacy) }), L = typeof v.lg > "u" ? false : !v.lg, k = e2 ?? b ?? Fo, c = t((V, X) => V.map((F2) => {
    let { icon: w, label: O, route: z2, key: Y, name: G, children: A, parentName: K, meta: j, options: J2 } = F2;
    if (A.length > 0)
      return import_react88.default.createElement(oc, { key: F2.key, resource: G.toLowerCase(), action: "list", params: { resource: F2 } }, import_react88.default.createElement(menu_default.SubMenu, { key: F2.key, icon: w ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: O }, c(A, X)));
    let se2 = Y === X, ee = !(F(j == null ? void 0 : j.parent, J2 == null ? void 0 : J2.parent, K) !== void 0 && A.length === 0);
    return import_react88.default.createElement(oc, { key: F2.key, resource: G.toLowerCase(), action: "list", params: { resource: F2 } }, import_react88.default.createElement(menu_default.Item, { key: F2.key, style: { fontWeight: se2 ? "bold" : "normal" }, icon: w ?? (ee && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(f, { to: z2 ?? "" }, O), !r && se2 && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), D = t(() => {
    l ? window.confirm(p("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (g(false), B()) : B();
  }, "handleLogout"), I = d && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: D, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, p("buttons.logout", "Logout")), U = h ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: P === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(f, { to: "/" }, p("dashboard.title", "Dashboard")), !r && P === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, Z2 = c(T, P), x = t(() => o2 ? o2({ dashboard: U, items: Z2, logout: I, collapsed: r }) : import_react88.default.createElement(import_react88.default.Fragment, null, U, Z2, I), "renderSider"), _ = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: P ? [P] : [], defaultOpenKeys: C, mode: "inline", onClick: () => {
    a(false), v.lg || n2(true);
  } }, x())), "renderMenu"), Q = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(k, { collapsed: false }), _()))), import_react88.default.createElement(button_default, { style: ft, size: "large", onClick: () => a(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, t(() => L ? Q() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: r, onCollapse: (V) => n2(V), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(k, { collapsed: r }), _()), "renderContent")());
}, "Sider");
var Bo = t(() => {
  let e2 = J(), { data: o2 } = Hr({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
  return o2 && (o2.name || o2.avatar) ? import_react89.default.createElement(layout_default.Header, { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react89.default.createElement(space_default, { style: { marginLeft: "8px" } }, (o2 == null ? void 0 : o2.name) && import_react89.default.createElement(typography_default.Text, { style: { color: "white" }, strong: true }, o2.name), (o2 == null ? void 0 : o2.avatar) && import_react89.default.createElement(avatar_default, { src: o2 == null ? void 0 : o2.avatar, alt: o2 == null ? void 0 : o2.name }))) : null;
}, "Header");
var Hs = t(({ children: e2, Header: o2, Sider: s, Title: r, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), d = s ?? Co, u = o2 ?? Bo, y = typeof a.sm > "u" ? true : a.sm;
  return import_react87.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react87.default.createElement(d, { Title: r }), import_react87.default.createElement(layout_default, null, import_react87.default.createElement(u, null), import_react87.default.createElement(layout_default.Content, null, import_react87.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), i && import_react87.default.createElement(i, null)), n2 && import_react87.default.createElement(n2, null)));
}, "Layout");
var Fo = t(({ collapsed: e2 }) => {
  let o2 = Z(), s = tt(), { Link: r } = re();
  return import_react90.default.createElement(o2 === "legacy" ? r : s, { to: "/" }, e2 ? import_react90.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center" } }, import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine-mini.svg", alt: "Refine", style: { margin: "0 auto", padding: "12px 0", maxHeight: "65.5px" } })) : import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine", style: { width: "200px", padding: "12px 24px" } }));
}, "Title");
var bt = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Lo = t(({ Title: e2, render: o2, meta: s }) => {
  let { token: r } = theme_default.useToken(), [n2, i] = (0, import_react92.useState)(false), [a, d] = (0, import_react92.useState)(false), u = Yr(), y = Z(), l = tt(), { warnWhen: g, setWarnWhen: m } = dt(), { Link: f } = re(), b = y === "legacy" ? f : l, p = Ys(), T = H(), { menuItems: P, selectedKey: C, defaultOpenKeys: v } = hu({ meta: s }), h = grid_default.useBreakpoint(), { hasDashboard: S } = se(), B = J(), { mutate: L } = mr({ v3LegacyAuthProviderCompatible: !!(B != null && B.isLegacy) }), k = typeof h.lg > "u" ? false : !h.lg, c = e2 ?? p ?? ko, D = t((V, X) => V.map((F2) => {
    let { icon: w, label: O, route: z2, key: Y, name: G, children: A, parentName: K, meta: j, options: J2 } = F2;
    if (A.length > 0)
      return import_react92.default.createElement(oc, { key: F2.key, resource: G.toLowerCase(), action: "list", params: { resource: F2 } }, import_react92.default.createElement(menu_default.SubMenu, { key: F2.key, icon: w ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: O }, D(A, X)));
    let se2 = Y === X, ee = !(F(j == null ? void 0 : j.parent, J2 == null ? void 0 : J2.parent, K) !== void 0 && A.length === 0);
    return import_react92.default.createElement(oc, { key: F2.key, resource: G.toLowerCase(), action: "list", params: { resource: F2 } }, import_react92.default.createElement(menu_default.Item, { key: F2.key, icon: w ?? (ee && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(b, { to: z2 ?? "" }, O), !n2 && se2 && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), I = t(() => {
    g ? window.confirm(T("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (m(false), L()) : L();
  }, "handleLogout"), U = u && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => I(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, T("buttons.logout", "Logout")), Z2 = S ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(b, { to: "/" }, T("dashboard.title", "Dashboard")), !n2 && C === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, x = D(P, C), _ = t(() => o2 ? o2({ dashboard: Z2, items: x, logout: U, collapsed: n2 }) : import_react92.default.createElement(import_react92.default.Fragment, null, Z2, x, U), "renderSider"), Q = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: C ? [C] : [], defaultOpenKeys: v, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    d(false), h.lg || i(true);
  } }, _())), "renderMenu"), H2 = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: a, onClose: () => d(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated } }, import_react92.default.createElement(c, { collapsed: false })), Q()))), import_react92.default.createElement(button_default, { style: bt, size: "large", onClick: () => d(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return k ? H2() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (V) => i(V), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: r.colorBgElevated } }, n2 ? import_react92.default.createElement(RightOutlined_default, { style: { color: r.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: r.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(c, { collapsed: n2 })), Q());
}, "ThemedSider");
var Do = t(() => {
  let { token: e2 } = theme_default.useToken(), o2 = J(), { data: s } = Hr({ v3LegacyAuthProviderCompatible: !!(o2 != null && o2.isLegacy) });
  return s && (s.name || s.avatar) ? import_react93.default.createElement(layout_default.Header, { style: { backgroundColor: e2.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react93.default.createElement(space_default, null, import_react93.default.createElement(space_default, { size: "middle" }, (s == null ? void 0 : s.name) && import_react93.default.createElement(typography_default.Text, { strong: true }, s.name), (s == null ? void 0 : s.avatar) && import_react93.default.createElement(avatar_default, { src: s == null ? void 0 : s.avatar, alt: s == null ? void 0 : s.name })))) : null;
}, "ThemedHeader");
var fn = t(({ children: e2, Header: o2, Sider: s, Title: r, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), d = s ?? Lo, u = o2 ?? Do, y = typeof a.sm > "u" ? true : a.sm;
  return import_react91.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react91.default.createElement(d, { Title: r }), import_react91.default.createElement(layout_default, null, import_react91.default.createElement(u, null), import_react91.default.createElement(layout_default.Content, null, import_react91.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), i && import_react91.default.createElement(i, null)), n2 && import_react91.default.createElement(n2, null)));
}, "ThemedLayout");
var Pn = "Refine Project";
var Cn = import_react94.default.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react94.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.7889 0.422291C12.6627 -0.140764 11.3373 -0.140764 10.2111 0.422291L2.21115 4.42229C0.85601 5.09986 0 6.48491 0 8V16C0 17.5151 0.85601 18.9001 2.21115 19.5777L10.2111 23.5777C11.3373 24.1408 12.6627 24.1408 13.7889 23.5777L21.7889 19.5777C23.144 18.9001 24 17.5151 24 16V8C24 6.48491 23.144 5.09986 21.7889 4.42229L13.7889 0.422291ZM8 8C8 5.79086 9.79086 4 12 4C14.2091 4 16 5.79086 16 8V16C16 18.2091 14.2091 20 12 20C9.79086 20 8 18.2091 8 16V8Z", fill: "currentColor" }), import_react94.default.createElement("path", { d: "M14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8Z", fill: "currentColor" }));
var ko = t(({ collapsed: e2, icon: o2 = Cn, text: s = Pn, wrapperStyles: r }) => {
  let { token: n2 } = theme_default.useToken(), i = Z(), a = tt(), { Link: d } = re();
  return import_react94.default.createElement(i === "legacy" ? d : a, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react94.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...r } }, import_react94.default.createElement("div", { style: { height: "24px", width: "24px", color: n2.colorPrimary } }, o2), !e2 && import_react94.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, s)));
}, "ThemedTitle");
var Bt = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Ro = t(({ Title: e2, render: o2, meta: s, fixed: r, activeItemDisabled: n2 = false }) => {
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: d, mobileSiderOpen: u, setMobileSiderOpen: y } = ct(), l = Yr(), g = Z(), m = tt(), { warnWhen: f, setWarnWhen: b } = dt(), { Link: p } = re(), T = g === "legacy" ? p : m, P = Ys(), C = H(), { menuItems: v, selectedKey: h, defaultOpenKeys: S } = hu({ meta: s }), B = grid_default.useBreakpoint(), { hasDashboard: L } = se(), k = J(), { mutate: c } = mr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof B.lg > "u" ? false : !B.lg, I = e2 ?? P ?? ce2, U = t((w, O) => w.map((z2) => {
    let { icon: Y, label: G, route: A, key: K, name: j, children: J2, parentName: se2, meta: ee, options: M } = z2;
    if (J2.length > 0)
      return import_react96.default.createElement(oc, { key: z2.key, resource: j.toLowerCase(), action: "list", params: { resource: z2 } }, import_react96.default.createElement(menu_default.SubMenu, { key: z2.key, icon: Y ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: G }, U(J2, O)));
    let oe = K === O, re2 = !(F(ee == null ? void 0 : ee.parent, M == null ? void 0 : M.parent, se2) !== void 0 && J2.length === 0), $ = n2 && oe ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(oc, { key: z2.key, resource: j.toLowerCase(), action: "list", params: { resource: z2 } }, import_react96.default.createElement(menu_default.Item, { key: z2.key, icon: Y ?? (re2 && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: $ }, import_react96.default.createElement(T, { to: A ?? "", style: $ }, G), !a && oe && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), Z2 = t(() => {
    f ? window.confirm(C("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (b(false), c()) : c();
  }, "handleLogout"), x = l && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => Z2(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, C("buttons.logout", "Logout")), _ = L ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(T, { to: "/" }, C("dashboard.title", "Dashboard")), !a && h === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, Q = U(v, h), H2 = t(() => o2 ? o2({ dashboard: _, items: Q, logout: x, collapsed: a }) : import_react96.default.createElement(import_react96.default.Fragment, null, _, Q, x), "renderSider"), V = t(() => import_react96.default.createElement(menu_default, { selectedKeys: h ? [h] : [], defaultOpenKeys: S, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, H2()), "renderMenu"), X = t(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: u, onClose: () => y(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react96.default.createElement(I, { collapsed: false })), V()))), import_react96.default.createElement(button_default, { style: Bt, size: "large", onClick: () => y(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (D)
    return X();
  let F2 = { backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` };
  return r && (F2.position = "fixed", F2.top = 0, F2.height = "100vh", F2.zIndex = 999), import_react96.default.createElement(import_react96.default.Fragment, null, r && import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react96.default.createElement(layout_default.Sider, { style: F2, collapsible: true, collapsed: a, onCollapse: (w, O) => {
    O === "clickTrigger" && d(w);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react96.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: i.colorBgElevated } }, a ? import_react96.default.createElement(RightOutlined_default, { style: { color: i.colorPrimary } }) : import_react96.default.createElement(LeftOutlined_default, { style: { color: i.colorPrimary } })) }, import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", padding: a ? "0" : "0 16px", display: "flex", justifyContent: a ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated, fontSize: "14px" } }, import_react96.default.createElement(I, { collapsed: a })), V()));
}, "ThemedSiderV2");
var Vo = t(({ isSticky: e2, sticky: o2 }) => {
  let { token: s } = theme_default.useToken(), r = J(), { data: n2 } = Hr({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) });
  if (!(n2 && (n2.name || n2.avatar)))
    return null;
  let a = { backgroundColor: s.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" };
  return F(o2, e2) && (a.position = "sticky", a.top = 0, a.zIndex = 1), import_react97.default.createElement(layout_default.Header, { style: a }, import_react97.default.createElement(space_default, null, import_react97.default.createElement(space_default, { size: "middle" }, (n2 == null ? void 0 : n2.name) && import_react97.default.createElement(typography_default.Text, { strong: true }, n2.name), (n2 == null ? void 0 : n2.avatar) && import_react97.default.createElement(avatar_default, { src: n2 == null ? void 0 : n2.avatar, alt: n2 == null ? void 0 : n2.name }))));
}, "ThemedHeaderV2");
var Zn = t(({ children: e2, Header: o2, Sider: s, Title: r, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a }) => {
  let d = grid_default.useBreakpoint(), u = s ?? Ro, y = o2 ?? Vo, l = typeof d.sm > "u" ? true : d.sm, g = !!u({ Title: r });
  return import_react95.default.createElement(xo, { initialSiderCollapsed: a }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: g }, import_react95.default.createElement(u, { Title: r }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(y, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: l ? 24 : 12 } }, e2), i && import_react95.default.createElement(i, null)), n2 && import_react95.default.createElement(n2, null))));
}, "ThemedLayoutV2");
var sa = "Refine Project";
var na2 = import_react98.default.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react98.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.7889 0.422291C12.6627 -0.140764 11.3373 -0.140764 10.2111 0.422291L2.21115 4.42229C0.85601 5.09986 0 6.48491 0 8V16C0 17.5151 0.85601 18.9001 2.21115 19.5777L10.2111 23.5777C11.3373 24.1408 12.6627 24.1408 13.7889 23.5777L21.7889 19.5777C23.144 18.9001 24 17.5151 24 16V8C24 6.48491 23.144 5.09986 21.7889 4.42229L13.7889 0.422291ZM8 8C8 5.79086 9.79086 4 12 4C14.2091 4 16 5.79086 16 8V16C16 18.2091 14.2091 20 12 20C9.79086 20 8 18.2091 8 16V8Z", fill: "currentColor" }), import_react98.default.createElement("path", { d: "M14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8Z", fill: "currentColor" }));
var ce2 = t(({ collapsed: e2, icon: o2 = na2, text: s = sa, wrapperStyles: r }) => {
  let { token: n2 } = theme_default.useToken(), i = Z(), a = tt(), { Link: d } = re();
  return import_react98.default.createElement(i === "legacy" ? d : a, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react98.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...r } }, import_react98.default.createElement("div", { style: { height: "24px", width: "24px", color: n2.colorPrimary } }, o2), !e2 && import_react98.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, s)));
}, "ThemedTitleV2");
var Ho = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: s = false, accessControl: r, meta: n2, children: i, onClick: a, ...d }) => {
  let { hidden: u, disabled: y, label: l, title: g, LinkComponent: m, to: f } = MD({ resource: e2 ?? o2, accessControl: r, meta: n2 });
  return u ? null : import_react99.default.createElement(m, { to: f, replace: false, onClick: (b) => {
    if (y) {
      b.preventDefault();
      return;
    }
    a && (b.preventDefault(), a(b));
  } }, import_react99.default.createElement(button_default, { icon: import_react99.default.createElement(PlusSquareOutlined_default, null), disabled: y, title: g, className: n.CreateButton, type: "primary", ...d }, !s && (i ?? l)));
}, "CreateButton");
var Oo = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, hideText: r = false, accessControl: n2, meta: i, children: a, onClick: d, ...u }) => {
  let { to: y, label: l, title: g, hidden: m, disabled: f, LinkComponent: b } = UD({ resource: e2 ?? o2, id: s, meta: i, accessControl: n2 });
  return m ? null : import_react100.default.createElement(b, { to: y, replace: false, onClick: (p) => {
    if (f) {
      p.preventDefault();
      return;
    }
    d && (p.preventDefault(), d(p));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: f, title: g, className: n.EditButton, ...u }, !r && (a ?? l)));
}, "EditButton");
var _e = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, onSuccess: r, mutationMode: n2, children: i, successNotification: a, errorNotification: d, hideText: u = false, accessControl: y, metaData: l, meta: g, dataProviderName: m, confirmTitle: f, confirmOkText: b, confirmCancelText: p, invalidates: T, ...P }) => {
  let { title: C, label: v, hidden: h, disabled: S, loading: B, confirmTitle: L, confirmOkLabel: k, cancelLabel: c, onConfirm: D } = vu({ resource: e2 ?? o2, id: s, dataProviderName: m, invalidates: T, meta: g, onSuccess: r, mutationMode: n2, errorNotification: d, successNotification: a, accessControl: y });
  return h ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: b ?? k, cancelText: p ?? c, okType: "danger", title: f ?? L, okButtonProps: { disabled: B }, onConfirm: D, disabled: typeof (P == null ? void 0 : P.disabled) < "u" ? P.disabled : S }, import_react101.default.createElement(button_default, { danger: true, loading: B, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: C, disabled: S, className: n.DeleteButton, ...P }, !u && (i ?? v)));
}, "DeleteButton");
var Ye = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, hideText: r = false, dataProviderName: n2, children: i, meta: a, metaData: d, ...u }) => {
  let { onClick: y, label: l, loading: g } = Lu({ resource: e2 ?? o2, id: s, dataProviderName: n2 });
  return import_react102.default.createElement(button_default, { onClick: y, icon: import_react102.default.createElement(RedoOutlined_default, { spin: g }), className: n.RefreshButton, ...u }, !r && (i ?? l));
}, "RefreshButton");
var Ra = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: s, hideText: r = false, accessControl: n2, meta: i, children: a, onClick: d, ...u }) => {
  let { to: y, label: l, title: g, hidden: m, disabled: f, LinkComponent: b } = LD({ resource: e2 ?? o2, id: s, accessControl: n2, meta: i });
  return m ? null : import_react103.default.createElement(b, { to: y, replace: false, onClick: (p) => {
    if (f) {
      p.preventDefault();
      return;
    }
    d && (p.preventDefault(), d(p));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: f, title: g, className: n.ShowButton, ...u }, !r && (a ?? l)));
}, "ShowButton");
var Ze = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: s = false, accessControl: r, meta: n2, children: i, onClick: a, ...d }) => {
  let { to: u, label: y, title: l, hidden: g, disabled: m, LinkComponent: f } = wD({ resource: e2 ?? o2, accessControl: r, meta: n2 });
  return g ? null : import_react104.default.createElement(f, { to: u, replace: false, onClick: (b) => {
    if (m) {
      b.preventDefault();
      return;
    }
    a && (b.preventDefault(), a(b));
  } }, import_react104.default.createElement(button_default, { icon: import_react104.default.createElement(BarsOutlined_default, null), disabled: m, title: l, className: n.ListButton, ...d }, !s && (i ?? y)));
}, "ListButton");
var ja = t(({ hideText: e2 = false, children: o2, ...s }) => {
  let { label: r } = SD();
  return import_react105.default.createElement(button_default, { type: "default", icon: import_react105.default.createElement(ExportOutlined_default, null), className: n.ExportButton, ...s }, !e2 && (o2 ?? r));
}, "ExportButton");
var Xe = t(({ hideText: e2 = false, children: o2, ...s }) => {
  let { label: r } = ID();
  return import_react106.default.createElement(button_default, { type: "primary", icon: import_react106.default.createElement(SaveOutlined_default, null), className: n.SaveButton, ...s }, !e2 && (o2 ?? r));
}, "SaveButton");
var ei = t(({ resourceNameOrRouteName: e2, resource: o2, recordItemId: s, hideText: r = false, accessControl: n2, meta: i, children: a, onClick: d, ...u }) => {
  let { to: y, LinkComponent: l, label: g, disabled: m, hidden: f, title: b } = ED({ id: s, resource: o2 ?? e2, accessControl: n2, meta: i });
  return f ? null : import_react107.default.createElement(l, { to: y, replace: false, onClick: (p) => {
    if (m) {
      p.preventDefault();
      return;
    }
    d && (p.preventDefault(), d(p));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: m, title: b, className: n.CloneButton, ...u }, !r && (a ?? g)));
}, "CloneButton");
var ii = t(({ uploadProps: e2, buttonProps: o2, hideText: s = false, children: r, loading: n2 }) => {
  let { label: i } = FD();
  return import_react108.default.createElement(upload_default, { ...e2 }, import_react108.default.createElement(button_default, { icon: import_react108.default.createElement(ImportOutlined_default, null), className: n.ImportButton, loading: n2, ...o2 }, !s && (r ?? i)));
}, "ImportButton");
var fi = t(({ canCreate: e2, title: o2, children: s, createButtonProps: r, resource: n2, wrapperProps: i, contentProps: a, headerProps: d, breadcrumb: u, headerButtonProps: y, headerButtons: l }) => {
  var S, B;
  let g = H(), { options: { breadcrumb: m } = {} } = se(), f = Z(), b = nt(), { resource: p, identifier: T } = z(n2), P = e2 ?? (((p == null ? void 0 : p.canCreate) ?? !!(p != null && p.create)) || r), C = typeof u > "u" ? m : u, v = P ? { size: "middle", resource: f === "legacy" ? p == null ? void 0 : p.route : T, ...r } : void 0, h = P ? import_react109.default.createElement(Ho, { ...v }) : null;
  return import_react109.default.createElement("div", { ...i ?? {} }, import_react109.default.createElement(Se, { ghost: false, title: o2 ?? g(`${T}.titles.list`, b(((S = p == null ? void 0 : p.meta) == null ? void 0 : S.label) ?? ((B = p == null ? void 0 : p.options) == null ? void 0 : B.label) ?? (p == null ? void 0 : p.label) ?? T, "plural")), extra: l ? import_react109.default.createElement(space_default, { wrap: true, ...y }, typeof l == "function" ? l({ defaultButtons: h, createButtonProps: v }) : l) : h, breadcrumb: typeof C < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, C) ?? void 0 : import_react109.default.createElement(Be, null), ...d ?? {} }, import_react109.default.createElement("div", { ...a ?? {} }, s)));
}, "List");
var Bi = t(({ title: e2, saveButtonProps: o2, children: s, resource: r, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: d, contentProps: u, headerButtonProps: y, headerButtons: l, footerButtonProps: g, footerButtons: m, goBack: f }) => {
  var D, I;
  let b = H(), { options: { breadcrumb: p } = {} } = se(), T = Z(), P = io(), { goBack: C } = ce(), v = nt(), { resource: h, action: S, identifier: B } = z(r), L = typeof i > "u" ? p : i, k = { ...n2 ? { disabled: true } : {}, ...o2, htmlType: "submit" }, c = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...k }));
  return import_react110.default.createElement("div", { ...a ?? {} }, import_react110.default.createElement(Se, { ghost: false, backIcon: f, onBack: S !== "list" || typeof S < "u" ? T === "legacy" ? C : P : void 0, title: e2 ?? b(`${B}.titles.create`, `Create ${v(((D = h == null ? void 0 : h.meta) == null ? void 0 : D.label) ?? ((I = h == null ? void 0 : h.options) == null ? void 0 : I.label) ?? (h == null ? void 0 : h.label) ?? B, "singular")}`), breadcrumb: typeof L < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, L) ?? void 0 : import_react110.default.createElement(Be, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, l ? typeof l == "function" ? l({ defaultButtons: null }) : l : null), ...d ?? {} }, import_react110.default.createElement(spin_default, { spinning: n2 }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...g ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: c, saveButtonProps: k }) : m : c)], ...u ?? {} }, s))));
}, "Create");
var Ai = t(({ title: e2, saveButtonProps: o2, mutationMode: s, recordItemId: r, children: n2, deleteButtonProps: i, canDelete: a, resource: d, isLoading: u = false, dataProviderName: y, breadcrumb: l, wrapperProps: g, headerProps: m, contentProps: f, headerButtonProps: b, headerButtons: p, footerButtonProps: T, footerButtons: P, goBack: C, autoSaveProps: v }) => {
  var J2, se2, ee;
  let h = H(), { options: { breadcrumb: S } = {} } = se(), { mutationMode: B } = Ae(), L = s ?? B, k = Z(), c = io(), D = ge(), { goBack: I, list: U } = ce(), Z2 = nt(), { resource: x, action: _, id: Q, identifier: H2 } = z(d), V = ou({ resource: x, action: "list" }), X = r ?? Q, F2 = typeof l > "u" ? S : l, w = (x == null ? void 0 : x.list) && !r, O = a ?? ((((J2 = x == null ? void 0 : x.meta) == null ? void 0 : J2.canDelete) ?? (x == null ? void 0 : x.canDelete)) || i), z2 = w ? { ...u ? { disabled: true } : {}, resource: k === "legacy" ? x == null ? void 0 : x.route : H2 } : void 0, Y = { ...u ? { disabled: true } : {}, resource: k === "legacy" ? x == null ? void 0 : x.route : H2, recordItemId: X, dataProviderName: y }, G = O ? { ...u ? { disabled: true } : {}, resource: k === "legacy" ? x == null ? void 0 : x.route : H2, mutationMode: L, onSuccess: () => {
    k === "legacy" ? U((x == null ? void 0 : x.route) ?? (x == null ? void 0 : x.name) ?? "") : D({ to: V });
  }, recordItemId: X, dataProviderName: y, ...i } : void 0, A = { ...u ? { disabled: true } : {}, ...o2 }, K = import_react111.default.createElement(import_react111.default.Fragment, null, v && import_react111.default.createElement(It, { ...v }), w && import_react111.default.createElement(Ze, { ...z2 }), import_react111.default.createElement(Ye, { ...Y })), j = import_react111.default.createElement(import_react111.default.Fragment, null, O && import_react111.default.createElement(_e, { ...G }), import_react111.default.createElement(Xe, { ...A }));
  return import_react111.default.createElement("div", { ...g ?? {} }, import_react111.default.createElement(Se, { ghost: false, backIcon: C, onBack: _ !== "list" && typeof _ < "u" ? k === "legacy" ? I : c : void 0, title: e2 ?? h(`${H2}.titles.edit`, `Edit ${Z2(((se2 = x == null ? void 0 : x.meta) == null ? void 0 : se2.label) ?? ((ee = x == null ? void 0 : x.options) == null ? void 0 : ee.label) ?? (x == null ? void 0 : x.label) ?? H2, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...b ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: K, listButtonProps: z2, refreshButtonProps: Y }) : p : K), breadcrumb: typeof F2 < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, F2) ?? void 0 : import_react111.default.createElement(Be, null), ...m ?? {} }, import_react111.default.createElement(spin_default, { spinning: u }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...T ?? {} }, P ? typeof P == "function" ? P({ defaultButtons: j, deleteButtonProps: G, saveButtonProps: A }) : P : j)], ...f ?? {} }, n2))));
}, "Edit");
var _i = t(({ title: e2, canEdit: o2, canDelete: s, isLoading: r = false, children: n2, resource: i, recordItemId: a, dataProviderName: d, breadcrumb: u, contentProps: y, headerProps: l, wrapperProps: g, headerButtons: m, footerButtons: f, footerButtonProps: b, headerButtonProps: p, goBack: T }) => {
  var Y, G, A;
  let P = H(), { options: { breadcrumb: C } = {} } = se(), v = Z(), h = io(), S = ge(), { goBack: B, list: L } = ce(), k = nt(), { resource: c, action: D, id: I, identifier: U } = z(i), Z2 = ou({ resource: c, action: "list" }), x = a ?? I, _ = typeof u > "u" ? C : u, Q = (c == null ? void 0 : c.list) && !a, H2 = s ?? ((Y = c == null ? void 0 : c.meta) == null ? void 0 : Y.canDelete) ?? (c == null ? void 0 : c.canDelete), V = o2 ?? (c == null ? void 0 : c.canEdit) ?? !!(c != null && c.edit), X = Q ? { resource: v === "legacy" ? c == null ? void 0 : c.route : U } : void 0, F2 = V ? { ...r ? { disabled: true } : {}, type: "primary", resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: x } : void 0, w = H2 ? { ...r ? { disabled: true } : {}, resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: x, onSuccess: () => {
    v === "legacy" ? L((c == null ? void 0 : c.route) ?? (c == null ? void 0 : c.name) ?? "") : S({ to: Z2 });
  }, dataProviderName: d } : void 0, O = { ...r ? { disabled: true } : {}, resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: x, dataProviderName: d }, z2 = import_react112.default.createElement(import_react112.default.Fragment, null, Q && import_react112.default.createElement(Ze, { ...X }), V && import_react112.default.createElement(Oo, { ...F2 }), H2 && import_react112.default.createElement(_e, { ...w }), import_react112.default.createElement(Ye, { ...O }));
  return import_react112.default.createElement("div", { ...g ?? {} }, import_react112.default.createElement(Se, { ghost: false, backIcon: T, onBack: D !== "list" && typeof D < "u" ? v === "legacy" ? B : h : void 0, title: e2 ?? P(`${U}.titles.show`, `Show ${k(((G = c == null ? void 0 : c.meta) == null ? void 0 : G.label) ?? ((A = c == null ? void 0 : c.options) == null ? void 0 : A.label) ?? (c == null ? void 0 : c.label) ?? U, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...p ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: z2, deleteButtonProps: w, editButtonProps: F2, listButtonProps: X, refreshButtonProps: O }) : m : z2), breadcrumb: typeof _ < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, _) ?? void 0 : import_react112.default.createElement(Be, null), ...l ?? {} }, import_react112.default.createElement(spin_default, { spinning: r }, import_react112.default.createElement(card_default, { bordered: false, actions: f ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...b }, typeof f == "function" ? f({ defaultButtons: null }) : f)] : void 0, ...y ?? {} }, n2))));
}, "Show");
var Xi = t(({ value: e2, ...o2 }) => import_react113.default.createElement(typography_default.Text, { ...o2 }, e2), "TextField");
var ol = t(({ value: e2, ...o2 }) => import_react114.default.createElement(tag_default, { ...o2 }, e2 == null ? void 0 : e2.toString()), "TagField");
var sl = t(({ value: e2, ...o2 }) => import_react115.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...o2 }, e2), "EmailField");
var il = t(({ value: e2, imageTitle: o2, ...s }) => import_react116.default.createElement(image_default, { ...s, src: e2, title: o2 }), "ImageField");
var ul = t(({ value: e2, valueLabelTrue: o2 = "true", valueLabelFalse: s = "false", trueIcon: r = import_react117.default.createElement(CheckOutlined_default, null), falseIcon: n2 = import_react117.default.createElement(CloseOutlined_default, null), ...i }) => import_react117.default.createElement(tooltip_default, { title: e2 ? o2 : s, ...i }, e2 ? import_react117.default.createElement("span", null, r) : import_react117.default.createElement("span", null, n2)), "BooleanField");
var yl = t(({ value: e2, locales: o2, format: s = "L", ...r }) => {
  import_dayjs5.default.extend(import_localizedFormat.default);
  let n2 = import_dayjs5.default.locale();
  return import_react118.default.createElement(typography_default.Text, { ...r }, (0, import_dayjs5.default)(e2).locale(o2 || n2).format(s));
}, "DateField");
var gl = t(({ title: e2, src: o2, ...s }) => import_react119.default.createElement(Go, { value: o2, title: e2, ...s }, e2 ?? o2), "FileField");
var Go = t(({ children: e2, value: o2, ...s }) => import_react120.default.createElement(typography_default.Link, { href: o2, ...s }, e2 ?? o2), "UrlField");
function Cl() {
  return !!(typeof Intl == "object" && Intl && typeof Intl.NumberFormat == "function");
}
t(Cl, "toLocaleStringSupportsOptions");
var Fl = t(({ value: e2, locale: o2, options: s, ...r }) => {
  let n2 = Number(e2);
  return import_react121.default.createElement(typography_default.Text, { ...r }, Cl() ? n2.toLocaleString(o2, s) : n2);
}, "NumberField");
var Ll = t(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var Rl = t((e2) => {
  let { setSelectedKeys: o2, confirm: s, clearFilters: r, mapValue: n2, selectedKeys: i, children: a } = e2, [d, u] = (0, import_react123.useState)(i), y = H(), l = t(() => {
    r && (u([]), r());
  }, "clearFilter"), g = t(() => {
    let p = m(d), T;
    typeof p == "number" ? T = `${p}` : import_dayjs6.default.isDayjs(p) ? T = [p.toISOString()] : T = p, o2(T), s == null || s();
  }, "onFilter"), m = t((p) => n2 ? n2(p) : p, "mappedValue"), f = t((p) => {
    if (typeof p == "object") {
      if (Array.isArray(p)) {
        let h = m(p);
        return u(h), o2(h);
      }
      let P = !p || !p.target || import_dayjs6.default.isDayjs(p) ? { target: { value: p } } : p, { target: C } = P, v = m(C.value);
      u(v);
      return;
    }
    let T = m(p);
    u(T);
  }, "onChange"), b = import_react123.default.Children.map(a, (p) => import_react123.default.isValidElement(p) ? import_react123.default.cloneElement(p, { onChange: f, value: m(d) }) : p);
  return import_react123.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react123.default.createElement("div", { style: { marginBottom: 15 } }, b), import_react123.default.createElement(space_default, null, import_react123.default.createElement(button_default, { type: "primary", size: "small", onClick: () => g() }, import_react123.default.createElement(FilterOutlined_default, null), " ", y("buttons.filter", "Filter")), import_react123.default.createElement(button_default, { danger: true, size: "small", onClick: () => l() }, y("buttons.clear", "Clear"))));
}, "FilterDropdown");
var Gl = t(() => {
  let [e2, o2] = (0, import_react124.useState)(), s = H(), { push: r } = ce(), n2 = ge(), i = Z(), { resource: a, action: d } = z();
  return (0, import_react124.useEffect)(() => {
    a && d && o2(s("pages.error.info", { action: d, resource: a == null ? void 0 : a.name }, `You may have forgotten to add the "${d}" component to "${a == null ? void 0 : a.name}" resource.`));
  }, [a, d]), import_react124.default.createElement(result_default, { status: "404", title: "404", extra: import_react124.default.createElement(space_default, { direction: "vertical", size: "large" }, import_react124.default.createElement(space_default, null, import_react124.default.createElement(typography_default.Text, null, s("pages.error.404", "Sorry, the page you visited does not exist.")), e2 && import_react124.default.createElement(tooltip_default, { title: e2 }, import_react124.default.createElement(InfoCircleOutlined_default, {}))), import_react124.default.createElement(button_default, { type: "primary", onClick: () => {
    i === "legacy" ? r("/") : n2({ to: "/" });
...
var op = t(() => {
  let [e2] = form_default.useForm(), o2 = H(), s = J(), { mutate: r, isLoading: n2 } = Ft({ v3LegacyAuthProviderCompatible: !!(s != null && s.isLegacy) }), i = import_react125.default.createElement(typography_default.Title, { level: 3, style: Qt }, o2("pages.login.title", "Sign in your account"));
...
var pp = t(() => ne.createElement(row_default, { align: "middle", justify: "center", style: He.root }, ne.createElement(col_default, { style: { textAlign: "center" } }, ne.createElement("img", { style: { marginBottom: "48px" }, src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" }), ne.createElement(typography_default.Title, { style: He.title }, "Welcome on board"), ne.createElement("p", { style: He.p1 }, "Your configuration is completed."), ne.createElement("p", { style: He.p2 }, "Now you can get started by adding your resources to the", " ", ne.createElement("code", { style: He.code }, "resources"), " property of", " ", ne.createElement("code", { style: He.code }, "<Refine>")), ne.createElement(space_default, { size: "large", wrap: true, style: { marginTop: "70px", justifyContent: "center" } }, ne.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, ne.createElement(button_default, { size: "large", icon: ne.createElement(ReadOutlined_default, null) }, "Documentation")), ne.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, ne.createElement(button_default, { size: "large", icon: ne.createElement(FolderOutlined_default, null) }, "Examples")), ne.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, ne.createElement(button_default, { size: "large", icon: ne.createElement(TeamOutlined_default, null) }, "Community"))))), "ReadyPage");
var mp = t(() => import_react126.default.createElement(Bu, null), "WelcomePage");
var ve = {};
...
var qo = t(({ providers: e2, registerLink: o2, forgotPasswordLink: s, rememberMe: r, contentProps: n2, wrapperProps: i, renderContent: a, formProps: d, title: u, hideForm: y }) => {
  let { token: l } = theme_default.useToken(), [g] = form_default.useForm(), m = H(), f = Z(), b = tt(), { Link: p } = re(), T = f === "legacy" ? p : b, P = J(), { mutate: C, isLoading: v } = Ft({ v3LegacyAuthProviderCompatible: !!(P != null && P.isLegacy) }), h = u === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, u ?? import_react128.default.createElement(ce2, { collapsed: false })), S = import_react128.default.createElement(typography_default.Title, { level: 3, style: { color: l.colorPrimaryTextHover, ...Ee } }, m("pages.login.title", "Sign in to your account")), B = t(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((k) => import_react128.default.createElement(button_default, { key: k.name, type: "default", block: true, icon: k.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => C({ providerName: k.name }) }, k.label)), !y && import_react128.default.createElement(divider_default, null, import_react128.default.createElement(typography_default.Text, { style: { color: l.colorTextLabel } }, m("pages.login.divider", "or")))) : null, "renderProviders"), L = import_react128.default.createElement(card_default, { title: S, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: l.colorBgElevated }, ...n2 ?? {} }, B(), !y && import_react128.default.createElement(form_default, { layout: "vertical", form: g, onFinish: (k) => C(k), requiredMark: false, initialValues: { remember: false }, ...d }, import_react128.default.createElement(form_default.Item, { name: "email", label: m("pages.login.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: m("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: m("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: m("pages.login.fields.password", "Password"), rules: [{ required: true }] }, import_react128.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, r ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, m("pages.login.buttons.rememberMe", "Remember me"))), s ?? import_react128.default.createElement(T, { style: { color: l.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, m("pages.login.buttons.forgotPassword", "Forgot password?"))), !y && import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: v, block: true }, m("pages.login.signin", "Sign in")))), o2 ?? import_react128.default.createElement("div", { style: { marginTop: y ? 16 : 8 } }, import_react128.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, m("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(T, { to: "/register", style: { fontWeight: "bold", color: l.colorPrimaryTextHover } }, m("pages.login.signup", "Sign up")))));
  return import_react128.default.createElement(layout_default, { style: ve, ...i ?? {} }, import_react128.default.createElement(row_default, { justify: "center", align: y ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: y ? "15dvh" : "16px" } }, import_react128.default.createElement(col_default, { xs: 22 }, a ? a(L, h) : import_react128.default.createElement(import_react128.default.Fragment, null, h, L))));
}, "LoginPage");
var _o = t(({ providers: e2, loginLink: o2, wrapperProps: s, contentProps: r, renderContent: n2, formProps: i, title: a, hideForm: d }) => {
  let { token: u } = theme_default.useToken(), [y] = form_default.useForm(), l = H(), g = Z(), m = tt(), { Link: f } = re(), b = g === "legacy" ? f : m, p = J(), { mutate: T, isLoading: P } = zr({ v3LegacyAuthProviderCompatible: !!(p != null && p.isLegacy) }), C = a === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react129.default.createElement(ce2, { collapsed: false })), v = import_react129.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...Ee } }, l("pages.register.title", "Sign up for your account")), h = t(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((B) => import_react129.default.createElement(button_default, { key: B.name, type: "default", block: true, icon: B.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => T({ providerName: B.name }) }, B.label)), !d && import_react129.default.createElement(divider_default, null, import_react129.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, l("pages.login.divider", "or")))) : null, "renderProviders"), S = import_react129.default.createElement(card_default, { title: v, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: u.colorBgElevated }, ...r ?? {} }, h(), !d && import_react129.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (B) => T(B), requiredMark: false, ...i }, import_react129.default.createElement(form_default.Item, { name: "email", label: l("pages.register.email", "Email"), rules: [{ required: true }, { type: "email", message: l("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: l("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: l("pages.register.fields.password", "Password"), rules: [{ required: true }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, o2 ?? import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, l("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(b, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, l("pages.login.signin", "Sign in")))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: P, block: true }, l("pages.register.buttons.submit", "Sign up")))), d && o2 !== false && import_react129.default.createElement("div", { style: { marginTop: d ? 16 : 8 } }, import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, l("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(b, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, l("pages.login.signin", "Sign in")))));
  return import_react129.default.createElement(layout_default, { style: ve, ...s ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: d ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: d ? "15dvh" : "16px" } }, import_react129.default.createElement(col_default, { xs: 22 }, n2 ? n2(S, C) : import_react129.default.createElement(import_react129.default.Fragment, null, C, S))));
}, "RegisterPage");
var Yo2 = t(({ loginLink: e2, wrapperProps: o2, contentProps: s, renderContent: r, formProps: n2, title: i }) => {
  let { token: a } = theme_default.useToken(), [d] = form_default.useForm(), u = H(), y = Z(), l = tt(), { Link: g } = re(), m = y === "legacy" ? g : l, { mutate: f, isLoading: b } = jr(), p = i === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react130.default.createElement(ce2, { collapsed: false })), T = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...Ee } }, u("pages.forgotPassword.title", "Forgot your password?")), P = import_react130.default.createElement(card_default, { title: T, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: a.colorBgElevated }, ...s ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: d, onFinish: (C) => f(C), requiredMark: false, ...n2 }, import_react130.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.register.buttons.haveAccount", "Have an account? "), " ", import_react130.default.createElement(m, { style: { fontWeight: "bold", color: a.colorPrimaryTextHover }, to: "/login" }, u("pages.login.signin", "Sign in")))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: b, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: ve, ...o2 ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react130.default.createElement(col_default, { xs: 22 }, r ? r(P, p) : import_react130.default.createElement(import_react130.default.Fragment, null, p, P))));
}, "ForgotPasswordPage");
var Zo = t(({ wrapperProps: e2, contentProps: o2, renderContent: s, formProps: r, title: n2 }) => {
  let { token: i } = theme_default.useToken(), [a] = form_default.useForm(), d = H(), u = J(), { mutate: y, isLoading: l } = Zr({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), g = n2 === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react131.default.createElement(ce2, { collapsed: false })), m = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: i.colorPrimaryTextHover, ...Ee } }, d("pages.updatePassword.title", "Set New Password")), f = import_react131.default.createElement(card_default, { title: m, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: i.colorBgElevated }, ...o2 ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: a, onFinish: (b) => y(b), requiredMark: false, ...r }, import_react131.default.createElement(form_default.Item, { name: "password", label: d("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: d("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true }, ({ getFieldValue: b }) => ({ validator(p, T) {
    return !T || b("password") === T ? Promise.resolve() : Promise.reject(new Error(d("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  } })] }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: l, block: true }, d("pages.updatePassword.buttons.submit", "Update")))));
  return import_react131.default.createElement(layout_default, { style: ve, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, s ? s(f, g) : import_react131.default.createElement(import_react131.default.Fragment, null, g, f))));
}, "UpdatePasswordPage");
var ad = t((e2) => {
  let { type: o2 } = e2;
  return import_react127.default.createElement(import_react127.default.Fragment, null, t(() => {
    switch (o2) {
      ...
      case "forgotPassword":
        return import_react127.default.createElement(Yo2, { ...e2 });
      case "updatePassword":
        return import_react127.default.createElement(Zo, { ...e2 });
      default:
        return import_react127.default.createElement(qo, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var Be = t(({ breadcrumbProps: e2, showHome: o2 = true, hideIcons: s = false, meta: r }) => {
  let n2 = Z(), { breadcrumbs: i } = _b({ meta: r }), a = tt(), { Link: d } = re(), { hasDashboard: u } = se(), { resources: y } = z(), l = No("/", y), g = n2 === "legacy" ? d : a;
  if (i.length === 1)
    return null;
  let m = i.map(({ label: b, icon: p, href: T }) => ({ key: `breadcrumb-item-${b}`, title: import_react132.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !s && p, T ? import_react132.default.createElement(g, { to: T }, b) : import_react132.default.createElement("span", null, b)) }));
  return import_react132.default.createElement(breadcrumb_default, { items: t(() => {
    var b, p;
    return o2 && (u || l.found) ? [{ key: "breadcrumb-item-home", title: import_react132.default.createElement(g, { to: "/" }, ((p = (b = l == null ? void 0 : l.resource) == null ? void 0 : b.meta) == null ? void 0 : p.icon) ?? import_react132.default.createElement(HomeOutlined_default, null)) }, ...m] : m;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var Se = t(({ children: e2, ...o2 }) => {
  let s = typeof o2.backIcon > "u" ? import_react133.default.createElement(button_default, { type: "text", icon: import_react133.default.createElement(ArrowLeftOutlined_default, null) }) : o2.backIcon, r = typeof o2.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, o2.title) : o2.title, n2 = typeof o2.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, o2.subTitle) : o2.subTitle;
  return import_react133.default.createElement(PageHeader, { ...o2, backIcon: s, title: r, subTitle: n2, style: { padding: 0, ...o2.style } }, e2);
}, "PageHeader");
var It = t(({ status: e2, elements: { success: o2 = import_react134.default.createElement(uo, { key: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: s = import_react134.default.createElement(uo, { key: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: r = import_react134.default.createElement(uo, { key: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react134.default.createElement(uo, { key: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(uc, { status: e2, elements: { success: o2, error: s, loading: r, idle: n2 } }), "AutoSaveIndicator");
var uo = t(({ key: e2, defaultMessage: o2, icon: s }) => {
  let r = H(), { token: n2 } = theme_default.useToken();
  return import_react134.default.createElement(typography_default.Text, { style: { marginRight: 5, color: n2.colorTextTertiary, fontSize: ".8rem" } }, r(e2, o2), import_react134.default.createElement("span", { style: { marginLeft: ".2rem" } }, s));
}, "Message");
var Ld = t((e2) => {
  let { fileList: o2 } = e2;
  return [...o2];
}, "getValueFromEvent");
var nC = { Blue: { token: { colorPrimary: "#1677FF" } }, Purple: { token: { colorPrimary: "#722ED1" } }, Magenta: { token: { colorPrimary: "#EB2F96" } }, Red: { token: { colorPrimary: "#F5222D" } }, Orange: { token: { colorPrimary: "#FA541C" } }, Yellow: { token: { colorPrimary: "#FAAD14" } }, Green: { token: { colorPrimary: "#52C41A" } } };
export {
  ad as AuthPage,
  ...
  Xi as TextField,
  Do as ThemedHeader,
  Vo as ThemedHeaderV2,
  fn as ThemedLayout,
  Ie as ThemedLayoutContext,
  xo as ThemedLayoutContextProvider,
  Zn as ThemedLayoutV2,
  Lo as ThemedSider,
  Ro as ThemedSiderV2,
  ko as ThemedTitle,
  ce2 as ThemedTitleV2,
  Fo as Title,
  Go as UrlField,
  mp as WelcomePage,
  Lr as getDefaultFilter,
  vr as getDefaultSortOrder,
  Ld as getValueFromEvent,
  yo as mapAntdFilterToCrudFilter,
  fo as mapAntdSorterToCrudSorting,
  Bf as notificationProvider,
  pc as useCheckboxGroup,
  st as useDrawerForm,
  Mr as useEditableTable,
  Zc as useFileUploadState,
  Te as useForm,
  wc as useImport,
  et as useModal,
  tt2 as useModalForm,
  Sf as useNotificationProvider,
  xc as useRadioGroup,
  Jm as useSelect,
  pf as useSiderVisible,
  Jr as useSimpleList,
  nt2 as useStepsForm,
  go as useTable,
  ct as useThemedLayoutContext
};
